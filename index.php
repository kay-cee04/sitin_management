...
<body>
    ...
    <script>
        ...
        if (params.get('error')) { showAlert(params.get('type')||'login','error', decodeURIComponent(params.get('error'))); openModal(params.get('type')||'login'); }
        if (params.get('success')) { showAlert(params.get('type')||'login','success', decodeURIComponent(params.get('success'))); openModal(params.get('type')||'login'); }
